...
import { GuitarsTotalCount, Guitars, Guitar, GuitarComments } from '../../types/guitars';
...
export const getGuitarComments = (state: State): GuitarComments => state[NameSpace.data].guitarComments;
